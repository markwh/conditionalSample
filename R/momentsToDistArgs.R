...
# foo = momentsToDistArgs('norm', c(0, 4)) bar = momentsToDistArgs('gamma', data.frame(means = runif(10, 1, 10), vars = runif(10, 10, 20)))
# do.call('rnorm', c(list(n = 10), foo)) do.call('rgamma', c(list(n = 10), bar)) 